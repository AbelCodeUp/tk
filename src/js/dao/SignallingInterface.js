...
class SignallingInterface{
    /*发送room-pubMsg信令
    * @method pubMsg*/
    pubMsg(signallingName ,id , toID ,  data , do_not_save , expiresabs){
        ...
        if(TkGlobal.appConnected) {
            ...
            ServiceRoom.getTkRoom().pubMsg(signallingName ,id , toID ,  data , save  , expiresabs);
        }
    };
    /*发送room-delMsg信令
     * @method pubMsg*/
    ...
    * @method sendSignallingDataToParticipant*/
    sendSignallingDataToParticipant( isDelMsg , signallingName ,id , toID ,  data , do_not_save , expiresabs){
        ...
        if(isDelMsg){
            ...
            that.pubMsg(  signallingName ,id , toID ,  data , do_not_save , expiresabs );
        }
    };
    /*删除所有信令的消息，从服务器上
