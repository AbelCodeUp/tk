...
import ChatBox_gogotalk from '../../../chatroom/index_gogotalk'
import ServiceRoom from 'ServiceRoom' ;


class RightVesselSmart_gogotalk extends React.Component{
    constructor(props){
        super(props);
        this.state = {
        ...
        return (
            <article id="video_chat_container" className="video-container add-position-relative add-fr" >{/*视频区域*/}
                ...
                <div className="chatmsg">
                    <div className="msgCount">0</div>
                    <ChatBox_gogotalk id={'chatbox'} videoContainerHeightRem={this.state.videoContainerHeightRem} />{/* xueln 聊天室组件*/}
                </div>
            </article>
        )
    };
};
export default  RightVesselSmart_gogotalk;
